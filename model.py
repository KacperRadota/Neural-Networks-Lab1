...
from model_parts.accuracies import AccuracyClassification, AccuracyRegression
from model_parts.activation_functions import ActivationSoftmax, ActivationLinear, ActivationReLU
from model_parts.layers import InputLayer, HiddenLayer
from model_parts.loss_functions import LossCategoricalCrossEntropy, LossMeanSquaredError
from model_parts.optimizers import OptimizerAdam
...
class NeuralNetwork:
    ...
    def train(self, X, y, *, epochs=1, batch_size=None,
        ...
        if show_plots:
            ...
            plt.plot(x_acc, y_acc, linestyle='-')
            plt.xlabel('Step')
            plt.ylabel('Accuracy')
            ...
            plt.plot(x_loss, y_loss, linestyle='-')
            plt.xlabel('Step')
            plt.ylabel('Loss')
